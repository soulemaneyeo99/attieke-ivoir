...
export default function CheckoutPage() {
    ...
    const handleOrderSubmit = async () => {
        ...
        try {
            ...
            setStep('success')
            // You might want to save the order number from response.data here if you had a state for it
            // For now we will rely on the static random one in the success view or update it.
            // Let's update the success view to show the real order number if possible.
            // But I cannot change the success 'view' state easily without adding a new state variable.
            // I will add a state variable for orderNumber.
        } catch (error) {
            console.error(error)
